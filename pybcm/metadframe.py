...
class MetaPandasObject(object):
    ...
    def save(self, outname):
        ''' Takes in str or opened file and saves. pickle.dump wrapper.'''
    ...
    def _transfer(self, dfnew):
        ...
        """
        newobj = copy.deepcopy(
            self)  # This looks like None, but is it type (MetaPandasObject, just __union__ prints None
        newobj._frame = dfnew
...
if __name__ == '__main__':
    ...
    # print(subclass)   ### Access underlying dataframe
